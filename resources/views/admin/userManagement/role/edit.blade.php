            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{route('admin.systemSetting.userManagement.role.index')}}" class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-list"></i> भूमिका सूची
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.systemSetting.userManagement.role.update',$role)}}" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
