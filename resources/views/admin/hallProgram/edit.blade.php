        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.hallProgram.update', $hallProgram) }}" method="post"
                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="program_date"
                                        value="{{ old('program_date', $hallProgram->program_date) }}"
                                        class="form-control @error('program_date') is-invalid @enderror" id="program_date"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea name="program_detail" id="program_detail" placeholder="कार्यक्रम बिवरण" class="form-control summernote"
                                        cols="30" rows="5">{{ old('program_detail',$hallProgram->program_detail) }}</textarea>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="program_time_to" value="{{ old('program_time_to',$hallProgram->program_time_to) }}"
                                        class="form-control @error('program_time_to') is-invalid @enderror"
                                        id="program_time_to" placeholder="मिति" required />
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="program_time_from" value="{{ old('program_time_from',$hallProgram->program_time_from) }}"
                                        class="form-control @error('program_time_from') is-invalid @enderror"
                                        id="program_time_from" placeholder="मिति" required />
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <select name="hall_id" id="hall_id"
                                        ...
                                        @foreach ($halls as $hall)
                                            <option value="{{ $hall->id }}"{{ old('hall_id',$hallProgram->hall_id) == $hall->id ? 'selected' : '' }}>{{ $hall->service }}
                                            </option>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <select name="ward[]" id="ward" class="form-select"
                                        ...
                                        @foreach (officeSetting()->localbody->ward_no ?? [] as $ward)
                                            <option value="{{ $ward }}"
                                                {{ in_array($ward, old('ward', $hallProgram->ward)) ? 'selected' : '' }}>
                                                {{ $ward }}</option>
                                        @endforeach
                                    </select>
                                    @error('ward')
