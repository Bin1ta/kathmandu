                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="font" value="{{ old('font', $header->font) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="font_size" value="{{ old('font_size', $header->font_size) }}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="position" value="{{ old('position', $header->position) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="font_color"
                                        value="{{ old('font_color', $header->font_color) }}"
