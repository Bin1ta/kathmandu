        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.popUpSetting.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-2">
                                    <input
                                            ...
                                            id="is_displayed"  @if(!empty(auth()->user()->ward_no)) disabled @endif/>
