            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> नागरिक वडापत्र सम्पादन थप्नुहोस्</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">नागरिक वडापत्र सम्पादन थप्नुहोस्</h4>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.citizenCharter.update',$citizenCharter) }}" method="POST"
                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select class="form-control @error('branch_id') is-invalid @enderror"
                                        ...
                                        @foreach ($branches as $branch)
                                            <option value="{{ $branch->id }}" {{old('branch_id',$citizenCharter->branch_id) == $branch->id ? 'selected' :''}}>{{ $branch->title }}</option>
                                        @endforeach
                                    </select>
                                    @error('branch_id')
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea id="required_document" class="form-control"
                                              name="required_document" cols="30"
